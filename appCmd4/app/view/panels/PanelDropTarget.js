Ext.define('appCmd4.view.panels.PanelDropTarget', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        appCmd4.view.panels.PanelDropTarget.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        appCmd4.view.panels.PanelDropTarget.superclass.unreg.call(this);
    }
});
