...
Ext.define('SearchTool.view.help.Reference', {
    ...
    itemId: 'help_ref',
    title: 'Help',
    requires: ['Ext.tab.Panel', 'SearchTool.view.help.ReferenceGrid', 'SearchTool.GridPortlet', 'SearchTool.PortalPanel', 'SearchTool.ChartPortlet', 'SearchTool.PortalColumn', 'SearchTool.Portlet'],
    resizable: true,
    floating: true,
    draggable: true,
    width: 425,
