Ext.define('SearchTool.util.SessionMonitor', {
  ...
  window: Ext.create('Ext.window.Window', {
    ...
    items: [{
      xtype: 'container',
      frame: true,
      html: "Your session will automatically expires after 15 minutes of  inactivity. If your session expires, any unsaved data will be lost and you will be automatically logged out. </br></br>If you want to continue working, click 'Continue'.</br></br>"    
    },{
      xtype: 'label',
      text: ''
    }],
